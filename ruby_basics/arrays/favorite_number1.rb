...
What does this look like? (You don't need to write any code here. Just alter the value shown 
so it meets the exercise requirements.)
=end

arr = ['Dave', 7, 'Miranda', 3, 'Jason', 11]

nested_arr = [['Dave', 7], ['Miranda', 3], ['Jason', 11]] # group with [] separate each array with a comma within the nest. 
